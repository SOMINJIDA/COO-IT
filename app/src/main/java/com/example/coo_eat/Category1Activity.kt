...
class Category1Activity : AppCompatActivity() {
    ...
    val TAG: String = "Category1 : " //log출력을 위한 TAG
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        CoroutineScope(Dispatchers.Main).launch {
            ...
            CoroutineScope(Dispatchers.IO).async {
                ...
                for (i in 0..list.length - 1) {
                    ...
                    if (n.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        if ((equal.size >= 2) and (category == "국&찌개")) {
            ...
            val Category1Layout: LinearLayout = findViewById(R.id.category1_main)

            for (i in 0..foodNames.size-1) {
                val foodImage = ImageView(this@Category1Activity)
                val foodName = TextView(this@Category1Activity)
                ...
                Glide.with(this@Category1Activity).load(foodImages[i]).into(foodImage)
                ...
                Category1Layout.addView(foodImage)
                Category1Layout.addView(foodName)

                foodImage.setOnClickListener {
                    val intent = Intent(this@Category1Activity, DetailActivity::class.java)
